			...
			<div id="menu" >
				<div class="pure-menu pure-menu-open">
					<a class="pure-menu-heading" href="#"><b>Lorem Ipsum</b></a>
								<ul class="accmenu" >
										<li class="item1"><a href="#">Inventory</a></li>
										<li class="item2"><a href="#">Sales</a></li>
										<li class="item5" ><a href="#">Reports</a>
											<ul class="submenu" >
												<li class="subitem1"  style="display:block !important"><a href="#">Inventory logs</a></li>
												<li class="subitem2"  style="display:block !important"><a href="#">Payment logs </a></li>
												<li class="subitem3"  style="display:block !important"><a href="#">Delivery logs </a></li>
											</ul>
										</li>
										<li class="item3"><a href="#">Account Settings </a></li>
										<li class="item4"><a href="#">Sign Out </a></li>

									</ul>
				</div>
			</div>
		</div>
			<div id="main">The standard Lorem Ipsum passage, used since the 1500s
